...
def main():
    ...
    forecast_scaler_path: str = r'Z:\01TRAINNING_DATA\scaler\250714\scaler_forecast.sav'
    real_scaler_path: str = r'Z:\01TRAINNING_DATA\scaler\250714\scaler_realdata.sav'
    out_put_pic_path: str = r'Z:\04TRAINNING_EVALUATION_PIC\MODEL_V7'
    out_put_rmse_path: str = r'Z:\04TRAINNING_EVALUATION_PIC\MODEL_V7'
